 ...
 *
 * `noindex`: a transactional step, not a landing page. `/spaces/coworking` is the
...
export async function generateMetadata({
  ...
  return pageMetadata(locale, "Booking", "/spaces/coworking/book", {
    noindex: true,
  });
}
...
export default async function Page({
  ...
  const {locale} = await params;
  return <BookingScreen locale={locale} space="coworking" />;
}
