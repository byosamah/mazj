...
function Content() {
  ...
  return (
    <>
      <PageIntro eyebrow={t("eyebrow")} title={t("title")} intro={t("intro")} image="/images/spaces/meeting.jpg" imageRatio="aspect-[4/5]" index="03" />
      <SpaceDetail
      ...
      <SpacesGrid detail showHeader={false} exclude="meetingRoom" heading={ts("otherTitle")} />
