 ...
 *
 * `noindex`: a transactional step, not a landing page. `/spaces/private-office` is the
...
export async function generateMetadata({
  ...
  return pageMetadata(locale, "Booking", "/spaces/private-office/book", {
    noindex: true,
  });
}
...
export default async function Page({
  ...
  const {locale} = await params;
  return <BookingScreen locale={locale} space="private-office" />;
}
